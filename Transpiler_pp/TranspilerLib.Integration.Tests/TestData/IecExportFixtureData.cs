...
namespace TranspilerLib.Integration.TestData;

/// <summary>
/// Provides access to IEC export fixtures that are stored as XML-based resource files.
/// The helper extracts the declaration and implementation structured-text blobs so integration tests
/// can operate on realistic exported source content without introducing cross-project test dependencies.
/// </summary>
