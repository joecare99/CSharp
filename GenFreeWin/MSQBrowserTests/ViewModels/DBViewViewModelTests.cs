...
PropChgn(MSQBrowser.ViewModels.DBViewViewModel,FileOpenName)=
PropChg(MSQBrowser.ViewModels.DBViewViewModel,FileOpenName)=
" })]
...
PropChgn(MSQBrowser.ViewModels.DBViewViewModel,FileOpenName)=
PropChg(MSQBrowser.ViewModels.DBViewViewModel,FileOpenName)=Resources\mydb.mdb
" })]
        ...
        [DataTestMethod()]
        [DataRow(null, new[] { "" })]
        [DataRow(EKind.Schema, new[] { @"PropChgn(MSQBrowser.ViewModels.DBViewViewModel,SelectedEntry)=
PropChg(MSQBrowser.ViewModels.DBViewViewModel,SelectedEntry)=(N:, K:Schema D:())
PropChgn(MSQBrowser.ViewModels.DBViewViewModel,CurrentView)=
PropChg(MSQBrowser.ViewModels.DBViewViewModel,CurrentView)=/Views/SchemaView.xaml
" })]
        [DataRow(EKind.Column, new[] { @"PropChgn(MSQBrowser.ViewModels.DBViewViewModel,SelectedEntry)=
PropChg(MSQBrowser.ViewModels.DBViewViewModel,SelectedEntry)=(N:, K:Column D:())
PropChgn(MSQBrowser.ViewModels.DBViewViewModel,CurrentView)=
PropChg(MSQBrowser.ViewModels.DBViewViewModel,CurrentView)=
" })]
