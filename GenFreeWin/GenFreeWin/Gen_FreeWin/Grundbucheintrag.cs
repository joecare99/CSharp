...
public class Grundbucheintrag : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        Label1.Font = new Font("Arial", 8.5f, FontStyle.Regular, GraphicsUnit.Point, 0);
        ...
        Label2.Font = new Font("Arial", 8.5f, FontStyle.Regular, GraphicsUnit.Point, 0);
        ...
        Label3.Font = new Font("Arial", 8.5f, FontStyle.Regular, GraphicsUnit.Point, 0);
        Label3.Location = new Point(501, 12);
        Label3.Margin = new Padding(4, 0, 4, 0);
        Label3.Name = "lblDisplayHint";
        Label3.Size = new Size(405, 22);
        Label3.TabIndex = 2;
        Label3.Text = "Art des Gebäudes";
        Label3.TextAlign = ContentAlignment.MiddleCenter;
        Label4.BackColor = Color.FromArgb(224, 224, 224);
        Label4.Font = new Font("Arial", 8.5f, FontStyle.Regular, GraphicsUnit.Point, 0);
        ...
        Label5.Font = new Font("Arial", 8.5f, FontStyle.Regular, GraphicsUnit.Point, 0);
        ...
        TextBox1.Size = new Size(63, 25);
        TextBox1.TabIndex = 5;
        TextBox2.Location = new Point(88, 38);
        TextBox2.Margin = new Padding(4);
        TextBox2.Multiline = true;
        TextBox2.Name = "edtSuburb";
        TextBox2.Size = new Size(400, 234);
        TextBox2.TabIndex = 6;
        TextBox3.Location = new Point(504, 38);
        TextBox3.Margin = new Padding(4);
        TextBox3.Multiline = true;
        TextBox3.Name = "edtCounty";
        TextBox3.Size = new Size(400, 234);
        TextBox3.TabIndex = 7;
        TextBox4.Location = new Point(13, 247);
        TextBox4.Margin = new Padding(4);
        TextBox4.Name = "edtCountry";
        TextBox4.Size = new Size(73, 25);
        TextBox4.TabIndex = 8;
        TextBox5.Location = new Point(16, 182);
        TextBox5.Margin = new Padding(4);
        TextBox5.Name = "edtNameprefix";
        TextBox5.Size = new Size(73, 25);
        TextBox5.TabIndex = 9;
        ...
        Button2.Location = new Point(583, 309);
        ...
        Button3.Location = new Point(765, 309);
        ...
        Label7.Location = new Point(346, 327);
