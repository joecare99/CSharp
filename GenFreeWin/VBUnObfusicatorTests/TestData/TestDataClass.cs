...
("ProjectData.CreateProjectError(-2146828268);", CodeBlockType.Operation, 5),
        ...
        ("+ DateTime.Today.Month.ToString() +", CodeBlockType.Operation, 4),
        ("\".\"", CodeBlockType.String, 4),
        ("+ DateTime.DateString.Left( 2) +", CodeBlockType.Operation, 4),
        ("\".\"", CodeBlockType.String, 4),
        ("+ DateTime.Today.Year.ToString();", CodeBlockType.Operation, 4),
