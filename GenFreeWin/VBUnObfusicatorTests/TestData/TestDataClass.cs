...
";
    ...
    IL_108c:
        ...
        ("public const string TestData()", CodeBlockType.Instruction, 0),
        ("{", CodeBlockType.Block, 1),
        ("", CodeBlockType.Instruction, 1),
        ("// Discarded unreachable code: IL_0085", CodeBlockType.LComment, 1),
        ("string test =", CodeBlockType.Instruction, 1),
        ...
        (");", CodeBlockType.Instruction, 1),
        ("switch", CodeBlockType.Instruction, 1),
("(test)", CodeBlockType.Instruction, 1),
        ("{", CodeBlockType.Block, 2),
        ("case", CodeBlockType.Instruction, 2),
        ("\"test\"", CodeBlockType.String, 2),
        (":", CodeBlockType.Label, 2),
        ("case", CodeBlockType.Instruction, 2),
        ("\"test2\"", CodeBlockType.String, 2),
        (":", CodeBlockType.Label, 2),
        ("break;", CodeBlockType.Instruction, 2),
        ...
        ("return", CodeBlockType.Instruction, 1),
("test;", CodeBlockType.Instruction, 1),
        ("}", CodeBlockType.Block, 1),};
        public static object TestDataList1_org() => new List<TokenData>() {
        ("private void Befehl_Click(object eventSender, EventArgs eventArgs)", CodeBlockType.Instruction, 0),
        ("{", CodeBlockType.Block, 1),
        ("int try0000_dispatch = -1;", CodeBlockType.Instruction, 1),
        ("int num = default(int);", CodeBlockType.Instruction, 1),
        ("short index = default(short);", CodeBlockType.Instruction, 1),
        ("int num2 = default(int);", CodeBlockType.Instruction, 1),
        ("int num3 = default(int);", CodeBlockType.Instruction, 1),
        ("int number = default(int);", CodeBlockType.Instruction, 1),
        ("string prompt = default(string);", CodeBlockType.Instruction, 1),
        ("while", CodeBlockType.Instruction, 1),
("(true)", CodeBlockType.Instruction, 1),
        ("{", CodeBlockType.Block, 2),
        ("try", CodeBlockType.Instruction, 2),
        ("{", CodeBlockType.Block, 3),
        ("", CodeBlockType.Instruction, 3),
        ("/*Note: ILSpy has introduced the following switch to emulate a goto from catch-block to try-block*/", CodeBlockType.Comment, 3),
        (";", CodeBlockType.Instruction, 3),
        ("int num4;", CodeBlockType.Instruction, 3),
        ("string text;", CodeBlockType.Instruction, 3),
        ("switch", CodeBlockType.Instruction, 3),
("(try0000_dispatch)", CodeBlockType.Instruction, 3),
        ("{", CodeBlockType.Block, 4),
        ("default:", CodeBlockType.Label, 4),
        ("num = 1;", CodeBlockType.Instruction, 4),
        ("index = Befehl.GetIndex((Button)eventSender);", CodeBlockType.Instruction, 4),
        ("goto IL_0015;", CodeBlockType.Goto, 4),
        ("case 1043:", CodeBlockType.Label, 4),
        ("{", CodeBlockType.Block, 5),
        ("num2 = num;", CodeBlockType.Instruction, 5),
        ("switch", CodeBlockType.Instruction, 5),
("(num3)", CodeBlockType.Instruction, 5),
        ("{", CodeBlockType.Block, 6),
        ("case 2:", CodeBlockType.Label, 6),
        ("break;", CodeBlockType.Instruction, 6),
        ...
        ("num4 = num2 + 1;", CodeBlockType.Instruction, 4),
        ("goto IL_031d;", CodeBlockType.Goto, 4),
        ("IL_0248:", CodeBlockType.Label, 4),
        ("num = 36;", CodeBlockType.Instruction, 4),
        ("number = Information.Err().Number;", CodeBlockType.Instruction, 4),
        ("goto IL_0258;", CodeBlockType.Goto, 4),
        ("IL_0258:", CodeBlockType.Label, 4),
        ("num = 39;", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(number == 25)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("goto IL_0262;", CodeBlockType.Goto, 5),
        ("}", CodeBlockType.Block, 5),
        ("goto IL_029b;", CodeBlockType.Goto, 4),
        ("IL_029b:", CodeBlockType.Label, 4),
        ("num = 46;", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(number == 55)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("goto IL_02a5;", CodeBlockType.Goto, 5),
        ("}", CodeBlockType.Block, 5),
        ("goto IL_02d0;", CodeBlockType.Goto, 4),
        ("IL_02d0:", CodeBlockType.Label, 4),
        ("num = 52;", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(Interaction.MsgBox(Conversion.ErrorToString(), MsgBoxStyle.OkCancel, (Information.Err().Number).AsString()) == MsgBoxResult.Cancel)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("ProjectData.EndApp();", CodeBlockType.Instruction, 5),
        ("}", CodeBlockType.Block, 5),
        ("goto IL_02f6;", CodeBlockType.Goto, 4),
        ("IL_00ad:", CodeBlockType.Label, 4),
        ("num = 9;", CodeBlockType.Instruction, 4),
        ("RichTextBox1.LoadFile(COND.Verz1 +", CodeBlockType.Instruction, 4),
        ("\"TEMP\\\\Text2.RTF\"", CodeBlockType.String, 4),
        (", RichTextBoxStreamType.RichText);", CodeBlockType.Instruction, 4),
        ("goto IL_00cc;", CodeBlockType.Goto, 4),
        ("IL_02f6:", CodeBlockType.Label, 4),
        ("num = 55;", CodeBlockType.Instruction, 4),
        ("ProjectData.ClearProjectError();", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(num2 == 0)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("throw", CodeBlockType.Instruction, 5),
("ProjectData.CreateProjectError(-2146828268);", CodeBlockType.Instruction, 5),
        ("}", CodeBlockType.Block, 5),
        ("goto IL_0315;", CodeBlockType.Goto, 4),
        ("IL_00cc:", CodeBlockType.Label, 4),
        ("num = 10;", CodeBlockType.Instruction, 4),
        ("Interaction.Shell(COND.Aus[7] +", CodeBlockType.Instruction, 4),
        ("\" \"", CodeBlockType.String, 4),
        ("+ COND.Verz1 +", CodeBlockType.Instruction, 4),
        ("\"Temp\\\\Text2.RTF\"", CodeBlockType.String, 4),
        (", AppWinStyle.MaximizedFocus);", CodeBlockType.Instruction, 4),
        ("goto end_IL_0000_2;", CodeBlockType.Goto, 4),
        ("IL_0315:", CodeBlockType.Label, 4),
        ("num4 = num2;", CodeBlockType.Instruction, 4),
        ("goto IL_031d;", CodeBlockType.Goto, 4),
        ("IL_031d:", CodeBlockType.Label, 4),
        ("num2 = 0;", CodeBlockType.Instruction, 4),
        ("switch", CodeBlockType.Instruction, 4),
("(num4)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("case 1:", CodeBlockType.Label, 5),
        ("break;", CodeBlockType.Instruction, 5),
        ...
        ("num = 47;", CodeBlockType.Instruction, 4),
        ("FileSystem.FileClose();", CodeBlockType.Instruction, 4),
        ("goto IL_02b4;", CodeBlockType.Goto, 4),
        ("IL_02b4:", CodeBlockType.Label, 4),
        ("num = 48;", CodeBlockType.Instruction, 4),
        ("ProjectData.ClearProjectError();", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(num2 == 0)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
...
("ProjectData.CreateProjectError(-2146828268);", CodeBlockType.Instruction, 5),
        ...
        ("num = 8;", CodeBlockType.Instruction, 4),
        ("RichTextBox1.SaveFile(COND.Verz1 +", CodeBlockType.Instruction, 4),
        ("\"TEMP\\\\Text2.RTF\"", CodeBlockType.String, 4),
        (", RichTextBoxStreamType.RichText);", CodeBlockType.Instruction, 4),
        ("goto IL_00ad;", CodeBlockType.Goto, 4),
        ("IL_0262:", CodeBlockType.Label, 4),
        ("num = 40;", CodeBlockType.Instruction, 4),
        ("prompt =", CodeBlockType.Instruction, 4),
        ("\"Das angegebene Gerät ist nicht bereit.\\rBitte einschalten oder abbrechen.\"", CodeBlockType.String, 4),
        (";", CodeBlockType.Instruction, 4),
        ("goto IL_026c;", CodeBlockType.Goto, 4),
        ("IL_026c:", CodeBlockType.Label, 4),
        ("num = 41;", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(Interaction.MsgBox(prompt, MsgBoxStyle.OkCancel,", CodeBlockType.Instruction, 4),
        ("\"Fehler\"", CodeBlockType.String, 4),
        (") == MsgBoxResult.Cancel)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("goto end_IL_0000_2;", CodeBlockType.Goto, 5),
        ("}", CodeBlockType.Block, 5),
        ("goto IL_027f;", CodeBlockType.Goto, 4),
        ("IL_027f:", CodeBlockType.Label, 4),
        ("num = 42;", CodeBlockType.Instruction, 4),
        ("ProjectData.ClearProjectError();", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(num2 == 0)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
...
("ProjectData.CreateProjectError(-2146828268);", CodeBlockType.Instruction, 5),
        ...
        ("num = 15;", CodeBlockType.Instruction, 4),
        ("MyProject.Forms.Druck.Show();", CodeBlockType.Instruction, 4),
        ("goto end_IL_0000_2;", CodeBlockType.Goto, 4),
        ("IL_0015:", CodeBlockType.Label, 4),
        ("ProjectData.ClearProjectError();", CodeBlockType.Instruction, 4),
        ("num3 = 2;", CodeBlockType.Instruction, 4),
        ("goto IL_001d;", CodeBlockType.Goto, 4),
        ("IL_001d:", CodeBlockType.Label, 4),
        ("num = 3;", CodeBlockType.Instruction, 4),
        ("text =", CodeBlockType.Instruction, 4),
        ("\"Datum \"", CodeBlockType.String, 4),
        ("+ DateTime.Today.Month.ToString() +", CodeBlockType.Instruction, 4),
        ("\".\"", CodeBlockType.String, 4),
        ("+ DateTime.DateString.Left( 2) +", CodeBlockType.Instruction, 4),
        ("\".\"", CodeBlockType.String, 4),
        ("+ DateTime.Today.Year.ToString();", CodeBlockType.Instruction, 4),
        ("goto IL_0073;", CodeBlockType.Goto, 4),
        ("IL_0073:", CodeBlockType.Label, 4),
        ("num = 4;", CodeBlockType.Instruction, 4),
        ("switch", CodeBlockType.Instruction, 4),
("(index)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("case 1:", CodeBlockType.Label, 5),
        ("break;", CodeBlockType.Instruction, 5),
        ("case 2:", CodeBlockType.Label, 5),
        ...
        ("num = 19;", CodeBlockType.Instruction, 4),
        ("MyProject.Forms.Hinter.CommonDialog1Save.Filter =", CodeBlockType.Instruction, 4),
        ...
        ("num = 20;", CodeBlockType.Instruction, 4),
        ("MyProject.Forms.Hinter.CommonDialog1Save.InitialDirectory = COND.GenPlu +", CodeBlockType.Instruction, 4),
        ("\"list\\\\\"", CodeBlockType.String, 4),
        (";", CodeBlockType.Instruction, 4),
        ("goto IL_0178;", CodeBlockType.Goto, 4),
        ("IL_0178:", CodeBlockType.Label, 4),
        ("num = 21;", CodeBlockType.Instruction, 4),
        ("MyProject.Forms.Hinter.CommonDialog1Save.FilterIndex = 2;", CodeBlockType.Instruction, 4),
        ("goto IL_0191;", CodeBlockType.Goto, 4),
        ("IL_0191:", CodeBlockType.Label, 4),
        ("num = 22;", CodeBlockType.Instruction, 4),
        ("MyProject.Forms.Hinter.CommonDialog1Save.ShowDialog();", CodeBlockType.Instruction, 4),
        ("goto IL_01aa;", CodeBlockType.Goto, 4),
        ("IL_01aa:", CodeBlockType.Label, 4),
        ("num = 23;", CodeBlockType.Instruction, 4),
        ("if", CodeBlockType.Instruction, 4),
("(Operators.CompareString(MyProject.Forms.Hinter.CommonDialog1Save.FileName,", CodeBlockType.Instruction, 4),
        ("\"\"", CodeBlockType.String, 4),
        (", TextCompare:", CodeBlockType.Label, 4),
        ("false) == 0)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("goto end_IL_0000_2;", CodeBlockType.Goto, 5),
        ("}", CodeBlockType.Block, 5),
        ("goto IL_01d0;", CodeBlockType.Goto, 4),
        ("IL_01d0:", CodeBlockType.Label, 4),
        ("num = 24;", CodeBlockType.Instruction, 4),
        ("switch", CodeBlockType.Instruction, 4),
("(MyProject.Forms.Hinter.CommonDialog1Save.FilterIndex)", CodeBlockType.Instruction, 4),
        ("{", CodeBlockType.Block, 5),
        ("case 1:", CodeBlockType.Label, 5),
        ("break;", CodeBlockType.Instruction, 5),
        ("case 2:", CodeBlockType.Label, 5),
        ...
        ("num = 31;", CodeBlockType.Instruction, 4),
        ("RichTextBox1.SaveFile(MyProject.Forms.Hinter.CommonDialog1Save.FileName, RichTextBoxStreamType.RichText);", CodeBlockType.Instruction, 4),
        ("goto end_IL_0000_2;", CodeBlockType.Goto, 4),
        ("IL_01f9:", CodeBlockType.Label, 4),
        ("num = 28;", CodeBlockType.Instruction, 4),
        ("RichTextBox1.SaveFile(MyProject.Forms.Hinter.CommonDialog1Save.FileName, RichTextBoxStreamType.PlainText);", CodeBlockType.Instruction, 4),
        ("goto end_IL_0000_2;", CodeBlockType.Goto, 4),
        ("IL_00f9:", CodeBlockType.Label, 4),
        ("num = 13;", CodeBlockType.Instruction, 4),
        ("RichTextBox1.Text =", CodeBlockType.Instruction, 4),
        ("\"\"", CodeBlockType.String, 4),
        (";", CodeBlockType.Instruction, 4),
        ("goto IL_010d;", CodeBlockType.Goto, 4),
        ("IL_010d:", CodeBlockType.Label, 4),
        ("num = 14;", CodeBlockType.Instruction, 4),
        ("Close();", CodeBlockType.Instruction, 4),
        ("goto IL_0117;", CodeBlockType.Goto, 4),
        ("end_IL_0000:", CodeBlockType.Label, 4),
        ("break;", CodeBlockType.Instruction, 4),
        ("}", CodeBlockType.Block, 4),
        ("}", CodeBlockType.Block, 3),
        ("catch", CodeBlockType.Instruction, 2),
        ("(Exception obj)", CodeBlockType.Instruction, 2),
        ("when (obj is not null && num3 != 0 && num2 == 0)", CodeBlockType.Instruction, 2),
        ("{", CodeBlockType.Block, 3),
        ("ProjectData.SetProjectError(obj);", CodeBlockType.Instruction, 3),
        ("try0000_dispatch = 1043;", CodeBlockType.Instruction, 3),
        ("continue;", CodeBlockType.Instruction, 3),
        ("}", CodeBlockType.Block, 3),
        ("throw", CodeBlockType.Instruction, 2),
("ProjectData.CreateProjectError(-2146828237);", CodeBlockType.Instruction, 2),
        ("continue;", CodeBlockType.Instruction, 2),
        ("end_IL_0000_2:", CodeBlockType.Label, 2),
        ("break;", CodeBlockType.Instruction, 2),
        ("}", CodeBlockType.Block, 2),
        ("if", CodeBlockType.Instruction, 1),
("(num2 != 0)", CodeBlockType.Instruction, 1),
        ("{", CodeBlockType.Block, 2),
        ("ProjectData.ClearProjectError();", CodeBlockType.Instruction, 2),
        ("}", CodeBlockType.Block, 2),
        ("}", CodeBlockType.Block, 1),
        };
        ...
        public static object TestDataList2_org() => new List<TokenData>() {
            ("private void Button2_Click(object sender, EventArgs e)", CodeBlockType.Instruction, 0),
            ("{", CodeBlockType.Block, 1),
            ("", CodeBlockType.Instruction, 1),
            ("//Discarded unreachable code: IL_0085", CodeBlockType.LComment, 1),
            ("int try0000_dispatch = -1;", CodeBlockType.Instruction, 1),
            ...
            ("int num2 = default(int);", CodeBlockType.Instruction, 1),
            ("int num = default(int);", CodeBlockType.Instruction, 1),
            ("byte b = default(byte);", CodeBlockType.Instruction, 1),
            ("while", CodeBlockType.Instruction, 1),
("(true)", CodeBlockType.Instruction, 1),
            ("{", CodeBlockType.Block, 2),
            ("try", CodeBlockType.Instruction, 2),
...
("(try0000_dispatch)", CodeBlockType.Instruction, 3),
            ...
            ("default:", CodeBlockType.Label, 4),
            ("ProjectData.ClearProjectError();", CodeBlockType.Instruction, 4),
            ("num3 = 1;", CodeBlockType.Instruction, 4),
...
("(num3)", CodeBlockType.Instruction, 5),
            ...
            ("goto end_IL_0000;", CodeBlockType.Goto, 6),
            ("}", CodeBlockType.Block, 6),
            ("int num4 = num2 + 1;", CodeBlockType.Instruction, 5),
            ("num2 = 0;", CodeBlockType.Instruction, 5),
            ("switch", CodeBlockType.Instruction, 5),
("(num4)", CodeBlockType.Instruction, 5),
            ("{", CodeBlockType.Block, 6),
            ("case 1:", CodeBlockType.Label, 6),
            ("break;", CodeBlockType.Instruction, 6),
            ("case 2:", CodeBlockType.Label, 6),
            ...
            ("num = 7;", CodeBlockType.Instruction, 4),
            ("FileSystem.Input(99, ref COND.Aus[b]);", CodeBlockType.Instruction, 4),
            ("goto IL_0048;", CodeBlockType.Goto, 4),
            ("IL_0007:", CodeBlockType.Label, 4),
            ("num = 2;", CodeBlockType.Instruction, 4),
            ("FileSystem.FileOpen(99, COND.GenPlu +", CodeBlockType.Instruction, 4),
            ("\"\\\\Init\\\\Druck_ini.dat\"", CodeBlockType.String, 4),
            (", OpenMode.Input);", CodeBlockType.Instruction, 4),
            ("goto IL_0024;", CodeBlockType.Goto, 4),
            ("IL_0024:", CodeBlockType.Label, 4),
            ("num = 3;", CodeBlockType.Instruction, 4),
            ("b = 0;", CodeBlockType.Instruction, 4),
            ("goto IL_0048;", CodeBlockType.Goto, 4),
            ("IL_0048:", CodeBlockType.Label, 4),
            ("num = 5;", CodeBlockType.Instruction, 4),
            ("if", CodeBlockType.Instruction, 4),
("(!FileSystem.EOF(99))", CodeBlockType.Instruction, 4),
            ("{", CodeBlockType.Block, 5),
            ...
            ("num = 9;", CodeBlockType.Instruction, 4),
            ("FileSystem.FileClose(99);", CodeBlockType.Instruction, 4),
            ("break;", CodeBlockType.Instruction, 4),
            ("IL_002b:", CodeBlockType.Label, 4),
            ("num = 6;", CodeBlockType.Instruction, 4),
            ("b = checked((byte)(unchecked(b) + 1));", CodeBlockType.Instruction, 4),
            ("goto IL_0033;", CodeBlockType.Goto, 4),
            ("end_IL_0000_2:", CodeBlockType.Label, 4),
            ("break;", CodeBlockType.Instruction, 4),
            ("}", CodeBlockType.Block, 4),
            ("num = 10;", CodeBlockType.Instruction, 3),
            ("Process.Start(COND.GenPlu +", CodeBlockType.Instruction, 3),
            ("\"\\\\Hilfe\\\\TeilB.PDF\"", CodeBlockType.String, 3),
            (");", CodeBlockType.Instruction, 3),
            ("break;", CodeBlockType.Instruction, 3),
            ...
            ("{", CodeBlockType.Block, 3),
            ("ProjectData.SetProjectError(obj);", CodeBlockType.Instruction, 3),
            ("try0000_dispatch = 196;", CodeBlockType.Instruction, 3),
            ("continue;", CodeBlockType.Instruction, 3),
            ("}", CodeBlockType.Block, 3),
            ("throw", CodeBlockType.Instruction, 2),
("ProjectData.CreateProjectError(-2146828237);", CodeBlockType.Instruction, 2),
...
("(num2 != 0)", CodeBlockType.Instruction, 1),
        ...
        public static object TestDataList3() => new List<TokenData>(){
            ("public void Test3()", CodeBlockType.Instruction, 0),
            ("{", CodeBlockType.Block, 1),
            ("Modul1.UbgT = (Text2[0].Text).Trim();", CodeBlockType.Instruction, 1),
            ("goto IL_105c;", CodeBlockType.Goto, 1),
            ("IL_105c:", CodeBlockType.Label, 1),
            ("num = 209;", CodeBlockType.Instruction, 1),
            ("if", CodeBlockType.Instruction, 1),
("(Modul1.UbgT ==", CodeBlockType.Instruction, 1),
            ("\"\"", CodeBlockType.String, 1),
            (")", CodeBlockType.Instruction, 1),
            ("{", CodeBlockType.Block, 2),
            ("goto IL_107c;", CodeBlockType.Goto, 2),
            ("}", CodeBlockType.Block, 2),
            ("else", CodeBlockType.Instruction, 1),
            ("{", CodeBlockType.Block, 2),
            ("test =", CodeBlockType.Instruction, 2),
            ("@\"\"\"Test\"\"\"", CodeBlockType.String, 2),
            (";", CodeBlockType.Instruction, 2),
            ("test2 =", CodeBlockType.Instruction, 2),
            ("$\"\\\"{test}\\\"\"", CodeBlockType.String, 2),
            (";", CodeBlockType.Instruction, 2),
            ("test3 =", CodeBlockType.Instruction, 2),
            ("$\"{{test}}\"", CodeBlockType.String, 2),
            (";", CodeBlockType.Instruction, 2),
            ...
            ("num = 210;", CodeBlockType.Instruction, 1),
            ("Modul1.UbgT =", CodeBlockType.Instruction, 1),
            ("\"\\\"\"", CodeBlockType.String, 1),
            (";", CodeBlockType.Instruction, 1),
            ("goto IL_108d;", CodeBlockType.Goto, 1),
            ("IL_108d:", CodeBlockType.Label, 1),
            ("num = 212;", CodeBlockType.Instruction, 1),
            ("DataModul.DB_PersonTable.Seek(", CodeBlockType.Instruction, 1),
            ("\">\"", CodeBlockType.String, 1),
            (", Modul1.UbgT, Modul1.PersInArb);", CodeBlockType.Instruction, 1),
            ("}", CodeBlockType.Block, 1),};
        public static object TestDataList4() => new List<TokenData>(){
         ("public void Test4()", CodeBlockType.Instruction, 0),
    ("{", CodeBlockType.Block, 1),
    ("goto IL_105c;", CodeBlockType.Goto, 1),
    ("IL_105c:", CodeBlockType.Label, 1),
    ("num = 209;", CodeBlockType.Instruction, 1),
    ...
    ("}", CodeBlockType.Block, 1),
        ...
        public static object TestDataList5() => new List<TokenData>(){
            ("public void Test5()", CodeBlockType.Instruction, 0),
            ("{", CodeBlockType.Block, 1),
            ("test =", CodeBlockType.Instruction, 1),
            ("\"Some unended string ... ;", CodeBlockType.String, 1),
            ("test2 =", CodeBlockType.Instruction, 1),
            ("$\"Some {(test.Length()>5?@\"\\\"\":\"7\")} nested string ...\"", CodeBlockType.String, 1),
            (";", CodeBlockType.Instruction, 1),
            ("test3 =", CodeBlockType.Instruction, 1),
        ...
        public static object TestDataList6() => new List<TokenData>() {
            ("public void Test6()", CodeBlockType.Instruction, 0),
            ("{", CodeBlockType.Block, 1),
            ("if", CodeBlockType.Instruction, 1),
            ("(true)", CodeBlockType.Instruction, 1),
            ("{", CodeBlockType.Block, 2),
        ...
        ("public void Test7()", CodeBlockType.Instruction, 0),
        ("{", CodeBlockType.Block, 1),
        ("if", CodeBlockType.Instruction, 1),
        ("(true)", CodeBlockType.Instruction, 1),
        ("goto IL_105c;", CodeBlockType.Goto, 1),
