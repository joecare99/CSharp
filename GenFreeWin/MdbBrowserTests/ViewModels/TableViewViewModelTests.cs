...
#pragma warning restore CS8618 // Ein Non-Nullable-Feld muss beim Beenden des Konstruktors einen Wert ungleich NULL enthalten. Erwägen Sie die Deklaration als Nullable.
        ...
        public void ParPropChangeTest(string sName, bool xAct, EKind kind, string sProp, bool xExp = false)
        {
            ...
            Assert.AreEqual(xExp ? @"PropChgn(MdbBrowser.ViewModels.TableViewViewModel,TableName)=
PropChgn(MdbBrowser.ViewModels.TableViewViewModel,TableData)=
PropChg(MdbBrowser.ViewModels.TableViewViewModel,TableData)=
PropChg(MdbBrowser.ViewModels.TableViewViewModel,TableName)=Test
" : "", DebugLog);
        }
...
PropChgn(MdbBrowser.ViewModels.TableViewViewModel,TableData)=
PropChg(MdbBrowser.ViewModels.TableViewViewModel,TableData)=
PropChg(MdbBrowser.ViewModels.TableViewViewModel,TableName)=Test5
", DebugLog);
        }
    }
}