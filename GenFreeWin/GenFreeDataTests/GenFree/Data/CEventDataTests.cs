...
#pragma warning restore CS8618 // Ein Non-Nullable-Feld muss beim Beenden des Konstruktors einen Wert ungleich NULL enthalten. Erwägen Sie die Deklaration als Nullable.
    ...
    public void Init()
    {
        ...
        testRS.Fields[EventFields.Art].Value.Returns(1, 2, 3);
        testRS.Fields[EventFields.PerFamNr].Value.Returns(2, 3, 4);
        testRS.Fields[EventFields.DatumV].Value.Returns(3, 4, 5);
        testRS.Fields[EventFields.DatumV_S].Value.Returns("DatumV_S");
        testRS.Fields[EventFields.DatumB].Value.Returns(5, 6, 7);
        testRS.Fields[EventFields.DatumB_S].Value.Returns("DatumB_S");
        testRS.Fields[EventFields.KBem].Value.Returns(7,8,9);
        testRS.Fields[EventFields.Ort].Value.Returns(8,9,10);
        testRS.Fields[EventFields.Ort_S].Value.Returns("Ort_S");
        testRS.Fields[EventFields.Reg].Value.Returns("Reg");
        testRS.Fields[EventFields.Platz].Value.Returns(9,10,11);
        testRS.Fields[EventFields.VChr].Value.Returns("VChr");
        testRS.Fields[EventFields.LfNr].Value.Returns(10,11,12);
        testRS.Fields[EventFields.Bem1].Value.Returns("Bem1");
        testRS.Fields[EventFields.Bem2].Value.Returns("Bem2");
        testRS.Fields[EventFields.Bem3].Value.Returns("Bem3");
        testRS.Fields[EventFields.Bem4].Value.Returns("Bem4");
        testRS.Fields[EventFields.ArtText].Value.Returns(11,12,13);
        testRS.Fields[EventFields.Zusatz].Value.Returns("Zusatz");
        testRS.Fields[EventFields.priv].Value.Returns(12,13,14);
        testRS.Fields[EventFields.DatumText].Value.Returns(13,14,15);
        testRS.Fields[EventFields.Causal].Value.Returns(14,15,16);
        testRS.Fields[EventFields.an].Value.Returns(15,16,17);
        testRS.Fields[EventFields.tot].Value.Returns("tot");
        testRS.Fields[EventFields.Hausnr].Value.Returns(16,17,18);
        testRS.Fields[EventFields.GrabNr].Value.Returns(17,18,19);
    ...
    public void UpdateTest(bool xMatch,bool xSetRS,bool xEd, string[]? asS)
    {
        ...
        if (xSetRS) {
            testRS.Fields[EventFields.Art].Value.Returns(1);
            testRS.Fields[EventFields.PerFamNr].Value.Returns(2);
            testRS.Fields[EventFields.LfNr].Value.Returns(10);
        }
