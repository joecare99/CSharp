...
namespace JCAMS.Core
{
    ...
    public static class SGraphics
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether transportation clearance exists.
        /// </summary>
        /// <value><c>true</c> if [x transport freigabe ex]; otherwise, <c>false</c>.</value>
        /// <autogeneratedoc />
        public static bool xTransClearanceEx { get; set; } = true;
...
/*            FillSolidEllipse(graphics, Red, Color.White);
        ...
        public static void BeUndEntladen1(Graphics gr, Rectangle R, int ActualState, bool BlinkState, int Position)
        {
            ...
            Color Transportfreigabe = xTransClearanceEx ? Color.WhiteSmoke : (((ActualState & 0x200) <= 0) ? Color.Red : Color.LimeGreen);
