...
namespace JCAMS.Core.System
{
    ...
    public class CStation : CPropNotificationClass, IHasID , IHasDescription, ISerializable, IXmlSerializable
    {
        ...
        public static CStation GetStation(long idStation)
        {
            lock (Stations)
            {
                return Stations.TryGetValue(idStation, out CStation station) ? station : null;
            }
        }

        /// <summary>
        /// F�llt eine <see cref="T:System.Runtime.Serialization.SerializationInfo" /> mit den Daten auf, die zum Serialisieren des Zielobjekts erforderlich sind.
        /// </summary>
        /// <param name="info">Die mit Daten zu f�llende <see cref="T:System.Runtime.Serialization.SerializationInfo" />.</param>
        ...
        /// Bei der Implementierung der <see langword="IXmlSerializable" />-Schnittstelle sollte von dieser Methode <see langword="null" /> (<see langword="Nothing" /> in Visual Basic) zur�ckgegeben werden. Wenn die Angabe eines benutzerdefinierten Schemas erforderlich ist, sollten Sie stattdessen das das <see cref="T:System.Xml.Serialization.XmlSchemaProviderAttribute" /> auf die Klasse anwenden.
        /// </summary>
