...
## Scope
Define the first test data and mocking standards baseline for `AA98_AvlnCodeStudio` so tests across the solution stay readable, maintainable, and consistent as the framework grows.
...
- Shared test helpers should be introduced only when they provide clear value.
