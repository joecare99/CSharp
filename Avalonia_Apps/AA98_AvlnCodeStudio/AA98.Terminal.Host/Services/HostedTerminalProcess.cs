...
/// <summary>
/// Wraps a running process and forwards redirected streams as terminal events.
/// </summary>
public sealed class HostedTerminalProcess : IHostedTerminalProcess
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HostedTerminalProcess"/> class.
    /// </summary>
    /// <param name="process">The underlying process.</param>
    public HostedTerminalProcess(Process process)
    {
        _process = process;
