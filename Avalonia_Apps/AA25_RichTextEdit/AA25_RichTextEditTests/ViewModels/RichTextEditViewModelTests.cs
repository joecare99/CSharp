...
/// </summary>
/// <autogeneratedoc />
namespace AA25_RichTextEdit.ViewModels.Tests;
...
public class RichTextEditViewModelTests : BaseTestViewModel<RichTextEditViewModel>
{
    ...
    [DataTestMethod()]
    [DataRow(nameof(IRichTextEditModel.Now), new[] { "PropChg(AA25_RichTextEdit.ViewModels.RichTextEditViewModel,Now)=24.08.2022 12:00:00\r\n" })]
    [DataRow("HasErrors", new[] { "PropChg(AA25_RichTextEdit.ViewModels.RichTextEditViewModel,HasErrors)=False\r\n" })]
    [DataRow("Dummy", new[] { "PropChg(AA25_RichTextEdit.ViewModels.RichTextEditViewModel,Dummy)=\r\n" })]
