...
{
    public override async Task<Microsoft.VisualStudio.TestTools.UnitTesting.TestResult[]> ExecuteAsync(ITestMethod testMethod)
    {
    ...
    private static async Task<Microsoft.VisualStudio.TestTools.UnitTesting.TestResult[]> ExecuteTestMethod(ITestMethod testMethod)
    {
