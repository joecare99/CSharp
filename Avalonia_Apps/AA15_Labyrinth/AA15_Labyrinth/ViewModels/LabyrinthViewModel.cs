...
public partial class LabyrinthViewModel : BaseViewModelCT, ILabyrinthViewModel
{
    ...
    public LabyrinthViewModel(ILabyrinthGenerator generator, IRandom random)
    { _generator = generator; _rnd = random; }
    ...
    public void Randomize() { Seed = _rnd.Next(0, int.MaxValue); Regenerate(); }
