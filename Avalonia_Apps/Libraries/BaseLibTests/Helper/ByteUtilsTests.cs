...
namespace BaseLib.Helper.Tests
{
    ...
    public class ByteUtilsTests
    {
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.SwitchBit(iVal, ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.SwitchBit(lVal, ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.SetBit(iVal, ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.SetBit(lVal, ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.ClearBit(iVal, ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.ClearBit(lVal, ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.BitMask32(ix));
        }
        ...
        {
            Assert.ThrowsExactly<ArgumentException>(() => ByteUtils.BitMask64(ix));
        }
