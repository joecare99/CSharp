...
public static class ObjectHelper
{
    extension(object? obj)
    {
        ...
        /// </code>
        /// </example>
        public int AsInt(int def = default) => obj switch
        {
            int i => i,
        ...
        /// </code>
        /// </example>
        public long AsLong(int def = default) => obj switch
        {
            long i => i,
        ...
        /// </code>
        /// </example>
        public T AsEnum<T>() where T : struct, Enum => obj switch
        {
            T t => t,
        ...
        /// </code>
        /// </example>
        public DateTime AsDate() => obj switch
        {
            DateTime dt => dt,
...
{
    extension<T>(Dictionary<int, T> dic)
    {
        /// <summary>
        ...
        /// </code>
        /// </example>
        public void SetIndex(T value, int index) => dic[index + 1] = value;
        ...
        /// </code>
        /// </example>
        public int GetIndex(T value) => dic.Where((itm) => itm.Value?.Equals(value) ?? false)
