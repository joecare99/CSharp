...
{
    private TimeSpanConverter testConverter = null!;
    ...
    [DataRow("3.6 Days", TypeCode.String, new object[] {(double)3.6d },  null, "3.60")]
    [DataRow("4.1 Days", TypeCode.String, new object[] { 4.1d, DateDifFormat.Hours }, null, "98.40")]
    [DataRow("5.9 Days", TypeCode.String, new object[] { 5.9d, DateDifFormat.Minutes }, null, "8496.00")]
    [DataRow("6.001 Days", TypeCode.String, new object[] { 6.001d, DateDifFormat.Seconds }, null, "518486.40")]
    [DataRow("6.501 Days", TypeCode.String, new object[] { 6.501d, (DateDifFormat)4 }, null, "0")]
    [DataRow("7.123 Days", TypeCode.String, new object[] { 7.123d, "Weeks" }, null, "7.12")]
