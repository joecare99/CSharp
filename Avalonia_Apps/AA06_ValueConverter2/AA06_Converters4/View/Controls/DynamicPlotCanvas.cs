...
//     (c) by Joe Care 2024
// </copyright>
// <summary>Dynamisches Canvas-Control f�r Avalonia mit MVVM-Support</summary>
// ***********************************************************************
...
using AvaloniaColor = Avalonia.Media.Color; // Alias f�r Avalonia Color
...
public class DynamicPlotCanvas : Control
{
    ...
    private void DrawArrow(DrawingContext context, RectangleF viewport, ArrowData arrow)
    {
        ...
        var brush = ViewModel?.Arrows?.PenData?.Item1 ?? Brushes.Red;
