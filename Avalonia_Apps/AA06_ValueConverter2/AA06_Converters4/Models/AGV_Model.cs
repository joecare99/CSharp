...
using AA06_Converters_4.Properties;
using System;
using System.Collections.Generic;
using AA06_Converters_4.Models.Interfaces;

namespace AA06_Converters_4.Models;

public partial class AGV_Model : ObservableObject, IAGVModel
{
  ...
  , NotifyPropertyChangedFor(nameof(VehicleRotation))]
    ...
    public Math2d.Vector AGVVelocity
    {
        get => Math2d.ByLengthAngle(Swivel1Velocity, Swivel1Angle)
