...
namespace AA22_AvlnCap.ViewModels.Tests;
...
public class WpfCapViewModelTests
{
    ...
    public void ModelTileChangeTest()
    {
        _m.FireTileChange();
        Assert.AreEqual("", _m.DebugOut);
        Assert.AreEqual("PropChange(AA22_AvlnCap.ViewModels.RowData,TileColor)\r\nPropChange(AA22_AvlnCap.ViewModels.RowData,TileColor)\r\nPropChange(AA22_AvlnCap.ViewModels.RowData,TileColor)\r\nPropChange(AA22_AvlnCap.ViewModels.RowData,TileColor)\r\n", DebugOut);
    }
