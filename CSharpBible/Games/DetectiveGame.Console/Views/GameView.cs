...
public class GameView
{
    ...
    private void ShowSuggestionDialog()
    {
        ...
        dlg.Closed += () =>
        {
            ...
            {
                // F�hre SuggestCommand mit Parametern aus => Erweiterung n�tig? Tempor�r direkt Service im VM erweitern w�re besser
                // Interim: direkten History-Eintrag erzeugen �ber VM StartCommand Logik simulieren
                // Besser: IGameViewModel erweitern � hier nur Trigger
                _vm.History.Add($"Verdacht gew�hlt: {dlg.SelectedPerson.Name}/{dlg.SelectedWeapon.Name}/{dlg.SelectedRoom.Name}");
                // Falls VM sp�ter Parameter akzeptiert: _vm.Suggest(dlg.SelectedPerson,...)
            }
        };
