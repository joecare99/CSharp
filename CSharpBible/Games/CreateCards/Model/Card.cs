...
namespace CreateCards.Model
{
    ...
    public class Card
    {
        public static Dictionary<CardValues, CardDrawDef> DrawDef = new() {
            { CardValues.Ace ,new(){   PrintValue="A", SuitSize= 0.8,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
                PntSuits=new[]{new PointF(0.5f,0.5f) } } },
            { CardValues._2 ,new(){    PrintValue="2", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
                PntSuits=new[]{new PointF(0.5f,0.3f), new PointF(0.5f, 0.7f) } } },
            { CardValues._3 ,new(){    PrintValue="3", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
                PntSuits=new[]{new PointF(0.7f,0.3f), new PointF(0.3f, 0.7f), new PointF(0.5f, 0.5f) } } },
            { CardValues._4 ,new(){    PrintValue="4", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
                PntSuits=new[]{ new PointF(0.3f, 0.3f), new PointF(0.7f, 0.7f), new PointF(0.3f, 0.7f), new PointF(0.7f, 0.3f) } } },
            { CardValues._5 ,new(){    PrintValue="5", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
                PntSuits=new[]{ new PointF(0.3f, 0.3f), new PointF(0.7f, 0.7f), new PointF(0.3f, 0.7f), new PointF(0.7f, 0.3f),
                    new PointF(0.5f, 0.5f) } } },
            { CardValues._6 ,new(){    PrintValue="6", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
                PntSuits=new[]{ new PointF(0.3f, 0.3f), new PointF(0.7f, 0.7f), new PointF(0.3f, 0.7f), new PointF(0.7f, 0.3f),
                    new PointF(0.3f, 0.5f), new PointF(0.7f, 0.5f) } } },
            { CardValues._7 ,new(){    PrintValue="7", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
            ...
            { CardValues.Jack ,new(){  PrintValue="J", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
            ...
            { CardValues.Queen ,new(){ PrintValue="Q", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
            ...
            { CardValues.King ,new(){  PrintValue="K", SuitSize= 0.2,ValSize= 0.15,
                PntVals=new[]{new PointF(0.1f,0.1f),new PointF(0.1f,0.9f),new PointF(0.9f,0.1f),new PointF(0.9f,0.9f) },
