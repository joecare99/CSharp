# MVVM_03_NotifyChange

> Deeper dive into change notification patterns.
...
| Metric | Status |
|--------|--------|
| Unit Tests | Implemented (see associated *Tests* project: MVVM_03_NotifyChangeTests) |
| Line Coverage | TBD |
| Branch Coverage | TBD |
| Method Coverage | TBD |
...
`
dotnet test MVVM_03_NotifyChangeTests --framework net481 /p:CollectCoverage=true /p:CoverletOutputFormat=lcov
`

Modern multi-target (.NET >= 6):
`
dotnet test MVVM_03_NotifyChangeTests -c Debug /p:CollectCoverage=true /p:CoverletOutputFormat=lcov \
