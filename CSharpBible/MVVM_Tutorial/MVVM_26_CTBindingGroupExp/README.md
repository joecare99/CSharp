...
> BindingGroup experimentation (Toolkit).
...
## Build & Run
`
dotnet build MVVM_26_CTBindingGroupExp
`
If multiple target frameworks (e.g., net6.0-windows + net481) exist, you can specify one:
`
dotnet build MVVM_26_CTBindingGroupExp -f net6.0-windows
`
Run (where an executable host exists):
`
dotnet run --project MVVM_26_CTBindingGroupExp -f net6.0-windows
`
