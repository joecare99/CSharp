...
| Metric | Status |
|--------|--------|
| Unit Tests | Implemented (see associated *Tests* project: MVVM_27_DataGridTests) |
| Line Coverage | TBD |
| Branch Coverage | TBD |
| Method Coverage | TBD |
...
`
dotnet test MVVM_27_DataGridTests --framework net481 /p:CollectCoverage=true /p:CoverletOutputFormat=lcov
`
