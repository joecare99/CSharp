# MVVM_06_Converters_4

> Advanced / performance notes for converters.
...
## Build & Run
`
dotnet build MVVM_06_Converters_4
`
If multiple target frameworks (e.g., net6.0-windows + net481) exist, you can specify one:
`
dotnet build MVVM_06_Converters_4 -f net6.0-windows
`
Run (where an executable host exists):
`
dotnet run --project MVVM_06_Converters_4 -f net6.0-windows
`
