...
namespace MVVM_25_RichTextEdit.Tests
{
...
#pragma warning restore CS8618 // Ein Non-Nullable-Feld muss beim Beenden des Konstruktors einen Wert ungleich NULL enthalten. Erwägen Sie die Deklaration als Nullable.
        ...
        public void Init()
        {
            ...
            IoC.GetReqSrv = (t) =>t switch {
                ...
                _ when t == typeof(IRichTextEditModel) => new RichTextEditModel(IoC.GetRequiredService<ISysTime>(),IoC.GetRequiredService<ILog>()),
        ...
        {
            app.DoStartUp();
            Assert.IsNotNull(IoC.GetReqSrv(typeof(IRichTextEditModel)));
