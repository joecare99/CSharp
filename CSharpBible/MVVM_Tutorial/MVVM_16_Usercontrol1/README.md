# MVVM_16_UserControl1

> Composing UI with UserControls.
...
## Build & Run
`
dotnet build MVVM_16_Usercontrol1
`
If multiple target frameworks (e.g., net6.0-windows + net481) exist, you can specify one:
`
dotnet build MVVM_16_Usercontrol1 -f net6.0-windows
`
Run (where an executable host exists):
`
dotnet run --project MVVM_16_Usercontrol1 -f net6.0-windows
`
