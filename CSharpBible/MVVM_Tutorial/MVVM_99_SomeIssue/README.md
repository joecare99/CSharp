...
> Sandbox for reproducing / isolating issues.
...
| Metric | Status |
|--------|--------|
| Unit Tests | Implemented (see associated *Tests* project: MVVM_99_SomeIssueTests) |
| Line Coverage | TBD |
| Branch Coverage | TBD |
| Method Coverage | TBD |
...
`
dotnet test MVVM_99_SomeIssueTests --framework net481 /p:CollectCoverage=true /p:CoverletOutputFormat=lcov
`

Modern multi-target (.NET >= 6):
`
dotnet test MVVM_99_SomeIssueTests -c Debug /p:CollectCoverage=true /p:CoverletOutputFormat=lcov \
