...
namespace MVVM_6_Converters_4.Model
{
    public class AGV_Model : NotificationObject, IAGVModel 
    {
        ...
        public double AGVRotation => Math2d.ByLengthAngle(Swivel1Velocity, Swivel1Angle)
        ...
        public IEnumerable<(string, string)> Dependencies => new[]{
            ...
            (nameof(AGVRotation),nameof(Swivel1Velocity)),
            (nameof(AGVRotation),nameof(Swivel2Velocity)),
            (nameof(AGVRotation),nameof(Swivel1Angle)),
            (nameof(AGVRotation),nameof(Swivel2Angle)),
        };
