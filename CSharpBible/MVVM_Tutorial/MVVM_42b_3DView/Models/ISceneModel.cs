...
public interface ISceneModel
{
    ...
    MeshGeometry3D NorthWallGeometry { get; }
    MeshGeometry3D SouthWallGeometry { get; }
    MeshGeometry3D EastWallGeometry { get; }
    MeshGeometry3D WestWallGeometry { get; }
    Brush FloorBrush { get; }
    Brush CeilingBrush { get; }
    Brush NorthWallBrush { get; }
    Brush SouthWallBrush { get; }
    Brush EastWallBrush { get; }
    Brush WestWallBrush { get; }
