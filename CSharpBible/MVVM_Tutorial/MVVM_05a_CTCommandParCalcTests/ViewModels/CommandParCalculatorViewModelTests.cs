...
canOperator(CalcResult=False)
canOperator(Add=False)
PropChg(MVVM_05a_CTCommandParCalc.ViewModels.CommandParCalculatorViewModel,Accumulator)=8
canOperator(CalcResult=False)
canOperator(Add=False)
...
canOperator(CalcResult=False)
canOperator(Add=False)
PropChg(MVVM_05a_CTCommandParCalc.ViewModels.CommandParCalculatorViewModel,Register)=8
canOperator(CalcResult=False)
canOperator(Add=False)
...
PropChg(MVVM_05a_CTCommandParCalc.ViewModels.CommandParCalculatorViewModel,Memory)=8
