...
namespace BaseLib.Helper
{
    ...
    public static class StringUtils
    {
        ...
        /// <autogeneratedoc />
        public static List<string> QuotedSplit(this string Data, string Seperator = ",", string QuoteMark = "\"")
        {
            ...
            foreach (var s in arPreSplit)
                ...
                {
                    result.Add(quotedStr + Seperator[0] + s.TrimEnd(' ').Substring(0, s.TrimEnd(' ').Length - 1));
                    quoteMode = false;
                    quotedStr = "";
                }
                else
                {
                    quotedStr += Seperator[0] + s;
                }
