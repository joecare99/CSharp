    ...
    public static class TypeUtils
    {
        ...
        private static Dictionary<Type, (string name, Func<object?, object?, bool>? compare, Func<object, object> convert)> _typeDic = new(){
            ...
            {typeof(Type),(nameof(System.Type),null,
                (o)=>o is string s? s.ToType(): o is TypeCode e?e.ToType(): typeof(object)) },
        ...
        public static bool Compare(this Type type, object? o1, object? o2)
            => _typeDic.TryGetValue(type, out var tv) ? tv.compare?.Invoke(o1, o2) ?? false : false;
        ...
        /// <summary>
        /// Determines whether the specified value is between min & max [incl. endvalues].
        /// </summary>
        /// <param name="val">The value.</param>
        /// <param name="min">The minimum.</param>
        /// <param name="max">The maximum.</param>
