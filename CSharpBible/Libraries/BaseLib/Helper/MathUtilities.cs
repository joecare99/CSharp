...
public static class MathUtilities
{
    extension(double newValue)
    {
        ...
        /// <autogeneratedoc />
        public double PT1(ref double actValue, double dTn_Ta = 0.1d, double KP = 1.0d)
        ...
        /// <returns>System.Double.</returns>
        /// <autogeneratedoc />
        public double Mean(double[] buffer, ref int ix)
        {
            buffer[ix++] = newValue;
            ix %= buffer.Length;
        ...
        /// <returns>System.Double.</returns>
        /// <autogeneratedoc />
        public double Median(double[] buffer, ref int ix, double fMedian = 0.5d)
        {
            buffer[ix++] = newValue;
            ix %= buffer.Length;
