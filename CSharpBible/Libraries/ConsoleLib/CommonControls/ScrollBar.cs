...
public class ScrollBar : Control
{
    ...
    {
        WidgetSet?.DrawScrollBar(this);
        Valid = true;
    }

    public (int Start, int Length) GetThumbData() => GetThumb();
    public bool IsDraggingThumb() => _dragging;
    public bool IsHoveringDecreaseArrow() => _hoverPart == Part.DecArrow;
    public bool IsHoveringIncreaseArrow() => _hoverPart == Part.IncArrow;
    public bool IsHoveringThumb() => _hoverPart == Part.Thumb;
