...
/// </summary>
public class ListBox : Control, IDisposable, IHasBorder
{
    ...
    public IBorderDefinition BorderDefinition { get; set; } = new BorderDef { Style = Data.BorderStyle.Single };
    ...
    {
        WidgetSet?.DrawListBox(this);
        Valid = true;
    }

    public int GetVisibleRows() => VisibleRows;
    public int GetItemCount() => ItemCount;
    public bool GetNeedScrollBar() => NeedScrollBar;
    public int GetTopIndex() => _topIndex;
    public int GetSelectedIndex() => _selectedIndex;
    public int GetHoverIndex() => _hoverIndex;
    public object? GetItemAt(int index) => _itemsSource?[index];
    public ScrollBar? GetVerticalScrollBar() => _vScroll;
    public IList? GetItemsSource() => _itemsSource;
    public void ApplyNativeSelectedIndex(int index)
    {
        SelectedIndex = index;
    }
