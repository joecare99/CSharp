...
namespace BaseLib.Helper
{
    ...
    public static class TestHelper
    {
        ...
        /// <autogeneratedoc />
        public static void AssertAreEqual<T>(T ExpData, T ActData, string[]? Excl=null, string Msg = "") where T : class
        {
                ...
                && (ActData is string a))
            {
                ...
                AssertAreEqual(e.Split(sSep, StringSplitOptions.None), a.Split(sSep, StringSplitOptions.None), Msg);
                return;
            }
        ...
        {
            string BldLns(int i, string[] aLines)
