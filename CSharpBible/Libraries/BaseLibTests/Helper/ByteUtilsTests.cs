...
namespace BaseLib.Helper.Tests
{
    ...
    public class ByteUtilsTests
    {
        ...
        [DataRow(-1, 31, false, int.MaxValue)]
        ...
        [DataTestMethod()]
        [DataRow(0, 0,true, 1L)]
        [DataRow(1L, 0, true, 1L)]
        [DataRow(-1L, 0, true, -1L)]
        [DataRow(-2L, 0, true, -1L)]
        [DataRow(0, 63, true, long.MinValue)]
        [DataRow(long.MinValue, 63, true, long.MinValue)]
        [DataRow(-1L, 63, true, -1L)]
        [DataRow(long.MaxValue, 63, true, -1L)]
        [DataRow(0, 0,false, 0)]
        [DataRow(1, 0, false, 0)]
        [DataRow(-1L, 0, false, -2L)]
        [DataRow(-2L, 0, false, -2L)]
        [DataRow(0, 63, false, 0)]
        [DataRow(long.MinValue, 63, false, 0)]
        [DataRow(-1L, 63, false, long.MaxValue)]
        [DataRow(long.MaxValue, 63, false, long.MaxValue)]
        public void SetBit7Test(long lVal, int ix,bool b, long lExp)
        {
