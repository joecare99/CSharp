...
namespace MVVM_BaseLibTests.ViewModel
{
    ...
    public class NotificationObjectCTTests : NotificationObjectCT
    {
        ...
        [DataRow("01-Test", 0, "Test", eValidReact.OK, "Test", "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\n")]
        ...
        [DataRow("01-Test", 0, "Test", eValidReact.OK, "Test", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString0a:Test\r\n" })]
        [DataRow("20-1 Empty", 2, "", eValidReact.OK, "", new string[] { "" })]
        [DataRow("20-2 Test", 2, "", eValidReact.NIO, "", new string[] { "" })]
        [DataRow("21-1 Test", 2, "Test", eValidReact.OK, "Test", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString2a:Test\r\nStrAct: ; Test\r\n" })]
        [DataRow("21-2 Test2", 2, "Test2", eValidReact.NIO, "Test2", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString2a:Test2\r\nStrAct: ; Test2\r\n" })]
        [DataRow("21-3 GEx", 2, "Test", eValidReact.GeneralException, "Test", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString2a:Test\r\nStrAct: ; Test\r\n" })]
        [DataRow("21-4 AEx", 2, "Test2", eValidReact.ArgumentException, "Test2", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString2a:Test2\r\nStrAct: ; Test2\r\n" })]
        [DataRow("60-1 Empty", 6, "", eValidReact.OK, "", new string[] { "" })]
        [DataRow("60-2 Test ", 6, "", eValidReact.NIO, "", new string[] { "" })]
        [DataRow("61-1 Test ", 6, "Test", eValidReact.OK, "Test", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString6a:Test\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\nStrAct: ; Test\r\n" })]
        [DataRow("61-2 Test2", 6, "Test2", eValidReact.NIO, "Test2", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString6a:Test2\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test2\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test2\r\nStrAct: ; Test2\r\n" })]
        [DataRow("61-3 GEx  ", 6, "Test", eValidReact.GeneralException, "Test", new string[] { "OnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString6a:Test\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\nStrAct: ; Test\r\n" })]
        ...
        [DataRow("71-1 Empty", 7, "Test", eValidReact.OK, "Test", new string[] { "Validate: Test, React:OK\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString7a:Test\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\nOnPropChanged: o:MVVM_BaseLibTests.ViewModel.NotificationObjectCTTests, p:TestString:Test\r\nStrAct: ; Test\r\n" })]
