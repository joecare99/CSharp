...
namespace ConsoleDisplay.View.Tests
{
	...
	public class HexMathTests {
		...
		[DataRow("-One", -1f, 1f)]
		[DataRow("Two", 2f, 0f)]
		[DataRow("-1.5", -1.5f, 0.5f)]
		[DataRow("-0.5", -0.5f, 0.5f)]
		[DataRow(" 0.5", 0.5f, 0.5f)]
		[DataRow(" 1.5", 1.5f, 0.5f)]
		[DataRow("-1.75", -1.75f, 0.25f)]
		[DataRow("-1.25", -1.25f, 0.75f)]
		[DataRow("-0.75", -0.75f, 0.75f)]
		[DataRow("-0.25", -0.25f, 0.25f)]
		[DataRow(" 0.25", 0.25f, 0.25f)]
		[DataRow(" 0.75", 0.75f, 0.75f)]
		[DataRow(" 1.25", 1.25f, 0.75f)]
		[DataRow(" 1.75", 1.75f, 0.25f)]
		...
		[DataTestMethod()]
		[TestProperty("Author", "J.C.")]
		[DataRow("Zero",  new float[] {0f, 0f},false, new float[] { 0f, 0f })]
		[DataRow("(0,1)", new float[] { 0f, 1f }, false, new float[] { 0.5f, 1f })]
		[DataRow("(0,2)", new float[] { 0f, 2f }, false, new float[] { 0f, 2f })]
		[DataRow("(1,0)", new float[] { 1f, 0f }, false, new float[] { 1f, 0f })]
		[DataRow("(1,1)", new float[] { 1f, 1f }, false, new float[] { 1.5f, 1f })]
		[DataRow("(1,2)", new float[] { 1f, 2f }, false, new float[] { 1f, 2f })]
		[DataRow("(2,0)", new float[] { 2f, 0f }, false, new float[] { 2f, 0f })]
		[DataRow("(2,1)", new float[] { 2f, 1f }, false, new float[] { 2.5f, 1f })]
		[DataRow("(2,2)", new float[] { 2f, 2f }, false, new float[] { 2f, 2f })]
		[DataRow("Zero",  new float[] { 0f, 0f }, true, new float[] { 0f, 0f })]
		[DataRow("(0,1)", new float[] { 0f, 1f }, true, new float[] { 0f, 1f })]
		[DataRow("(0,2)", new float[] { 0f, 2f }, true, new float[] { 0f, 2f })]
		[DataRow("(1,0)", new float[] { 1f, 0f }, true, new float[] { 1f, 0.5f })]
		[DataRow("(1,1)", new float[] { 1f, 1f }, true, new float[] { 1f, 1.5f })]
		[DataRow("(1,2)", new float[] { 1f, 2f }, true, new float[] { 1f, 2.5f })]
		[DataRow("(2,0)", new float[] { 2f, 0f }, true, new float[] { 2f, 0f })]
		[DataRow("(2,1)", new float[] { 2f, 1f }, true, new float[] { 2f, 1f })]
		[DataRow("(2,2)", new float[] { 2f, 2f }, true, new float[] { 2f, 2f })]
    ...
    public class TileDisplayHexTests
    {
        ...
        {
            TileDisplayHex.defaultTile = (Enum)VTiles.zero;
...
\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\cA0@°\c6E\\__\c6F \c00";
		...
		public void UpdateTest(string name, VTiles vt, VTiles vt2, string[] sExp)
        {
            ...
            tileDisplayHex.FncGetTile = (p) => vt2;
            tileDisplayHex.FullRedraw();
            Application.DoEvents();
		...
		public void UpdateTest2(string name, VTiles vt, VTiles vt2, string[] sExp) {
			...
			tileDisplayHex.FullRedraw();
			Application.DoEvents();
			Assert.AreEqual(cExpUpdateText2[(int)vt2], _tstCon.Content);
		...
		public void UpdateTest3(string name, VTiles vt, VTiles vt2, string[] sExp) {
			...
			tileDisplayHex.FullRedraw();
			Application.DoEvents();
			Assert.AreEqual(cExpUpdateText3[(int)vt2], _tstCon.Content);
