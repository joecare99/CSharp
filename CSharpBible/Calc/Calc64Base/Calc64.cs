...
// ***********************************************************************
// <copyright file="Calc64.cs" company="Hewlett-Packard Company">
...
namespace Calc64Base
{
    ...
    public class Calc64
    {
     ...
     CalcOperation
        ...
        public bool IsRegisterOpeation(
#if NET5_0_OR_GREATER
     CalcOperation?
#else
     CalcOperation
 ...
 co) => co?.NeedRegister ?? false;
        ...
        public bool IsRegisterOpeation(string shortDesc) => IsRegisterOpeation(ToCalcOperation(shortDesc));
        /// <summary>
        ...
        public bool IsRegisterOpeation(int id) => IsRegisterOpeation(ToCalcOperation(id));
