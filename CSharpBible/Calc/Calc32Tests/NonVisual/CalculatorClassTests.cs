...
#pragma warning restore CS8618 // Ein Non-Nullable-Feld muss beim Beenden des Konstruktors einen Wert ungleich NULL enthalten. Erwägen Sie die Deklaration als Nullable.
        ...
        {
            DebugLog += $"{sender?.GetType().Name}.Change({e.Item1},{e.Item2}=>{e.Item3}){Environment.NewLine}";
            nChanges++;
        }
        ...
        /// </summary>
        [TestMethod()]
        [DataRow("4", 4, false, 0, "CalculatorClass.Change(Accumulator,4=>0)\r\n")]
        ...
        /// </summary>
        [TestMethod()]
        [DataRow("4+3", CalculatorClass.eOpMode.Plus, new int[] { 4, 3 }, 7, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>4)
CalculatorClass.Change(OperationText,==>+)
CalculatorClass.Change(Register,0=>4)
CalculatorClass.Change(Accumulator,4=>3)
CalculatorClass.Change(Accumulator,3=>7)
CalculatorClass.Change(OperationText,+=>=)
CalculatorClass.Change(Register,4=>0)
" })]
        [DataRow("12-4", CalculatorClass.eOpMode.Minus, new int[] { 12, 4 }, 8, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>12)
CalculatorClass.Change(OperationText,==>-)
CalculatorClass.Change(Register,0=>12)
CalculatorClass.Change(Accumulator,12=>4)
CalculatorClass.Change(Accumulator,4=>8)
CalculatorClass.Change(OperationText,-=>=)
CalculatorClass.Change(Register,12=>0)
" })]
        [DataRow("7*6", CalculatorClass.eOpMode.Multiply, new int[] { 7, 6 }, 42, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>7)
CalculatorClass.Change(OperationText,==>*)
CalculatorClass.Change(Register,0=>7)
CalculatorClass.Change(Accumulator,7=>6)
CalculatorClass.Change(Accumulator,6=>42)
CalculatorClass.Change(OperationText,*=>=)
CalculatorClass.Change(Register,7=>0)
" })]
        [DataRow("99/11", CalculatorClass.eOpMode.Divide, new int[] { 99, 11 }, 9, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>99)
CalculatorClass.Change(OperationText,==>/)
CalculatorClass.Change(Register,0=>99)
CalculatorClass.Change(Accumulator,99=>11)
CalculatorClass.Change(Accumulator,11=>9)
CalculatorClass.Change(OperationText,/=>=)
CalculatorClass.Change(Register,99=>0)
" })]
        [DataRow("99 & 7", CalculatorClass.eOpMode.BinaryAnd, new int[] { 99, 7 }, 3, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>99)
CalculatorClass.Change(OperationText,==>&)
CalculatorClass.Change(Register,0=>99)
CalculatorClass.Change(Accumulator,99=>7)
CalculatorClass.Change(Accumulator,7=>3)
CalculatorClass.Change(OperationText,&=>=)
CalculatorClass.Change(Register,99=>0)
" })]
        [DataRow("12 | 7", CalculatorClass.eOpMode.BinaryOr, new int[] { 12, 7 }, 15, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>12)
CalculatorClass.Change(OperationText,==>|)
CalculatorClass.Change(Register,0=>12)
CalculatorClass.Change(Accumulator,12=>7)
CalculatorClass.Change(Accumulator,7=>15)
CalculatorClass.Change(OperationText,|=>=)
CalculatorClass.Change(Register,12=>0)
" })]
        [DataRow("12 x 7", CalculatorClass.eOpMode.BinaryXor, new int[] { 12, 7 }, 11, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>12)
CalculatorClass.Change(OperationText,==>x)
CalculatorClass.Change(Register,0=>12)
CalculatorClass.Change(Accumulator,12=>7)
CalculatorClass.Change(Accumulator,7=>11)
CalculatorClass.Change(OperationText,x=>=)
CalculatorClass.Change(Register,12=>0)
" })]
        [DataRow("12 ! 7", CalculatorClass.eOpMode.BinaryNot, new int[] { 12, -2 }, -2, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>12)
CalculatorClass.Change(Accumulator,12=>-13)
CalculatorClass.Change(Accumulator,-13=>-2)
" })]
        [DataRow("12 ~ 7", CalculatorClass.eOpMode.Negate, new int[] { 12, -2 }, -2, new string[] { @"CalculatorClass.Change(OperationText,=>=)
CalculatorClass.Change(Accumulator,0=>12)
CalculatorClass.Change(Accumulator,12=>-12)
CalculatorClass.Change(Accumulator,-12=>-2)
" })]
