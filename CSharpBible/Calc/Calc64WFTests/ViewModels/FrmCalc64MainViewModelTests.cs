...
#pragma warning disable CS8618 // Ein Non-Nullable-Feld muss beim Beenden des Konstruktors einen Wert ungleich NULL enthalten. Erwägen Sie die Deklaration als Nullable.
        private IFrmCalc64MainViewModel _ModelView;
...
#pragma warning restore CS8618 // Ein Non-Nullable-Feld muss beim Beenden des Konstruktors einen Wert ungleich NULL enthalten. Erwägen Sie die Deklaration als Nullable.
        ...
        public void TestInitialize()
        {
            ...
            ClearResults();
            _ModelView = new FrmCalc64MainViewModel(_calc);
        ...
        /// <autogeneratedoc />
        [DataTestMethod()]
        [DataRow("0" ,false, Keys.None, "")]
        [DataRow("01",false, Keys.Oemplus, "", null, 2)]
        [DataRow("01a",true, Keys.Oemplus, "", null, 4)]
        [DataRow("02",false, Keys.Add, "", null, 2)]
        [DataRow("03",false, Keys.OemMinus, "", null, 3)]
        [DataRow("04",false, Keys.Subtract, "", null, 3)]
        [DataRow("05",false, Keys.Divide, "", null, 5)]
        [DataRow("06",false, Keys.Multiply, "", null, 4)]
        [DataRow("07",false, Keys.Escape, "", null, null)]
        [DataRow("08",false, Keys.Back, "")]
        [DataRow("10",false, Keys.A, "", 10, null)]
        [DataRow("11",false, Keys.NumPad1, "",1,null)]
        [DataRow("12",false, Keys.D2, "",2,null)]
        public void MainWindow_frm_KeyDown(string sName,bool xShift, Keys keys, string sExpPC, int? iNumber= null,int? iOperation = null)
        {
            var e = new KeyEventArgs(keys | (xShift ? Keys.Shift:Keys.None));
            _ModelView.frm_KeyDown(this, null!, e);
            Assert.AreEqual(sExpPC, _PropChanged, $"Test: {keys}.PropChanges");
            if (iNumber.HasValue)
              _calc.Received(1).Button(iNumber.Value);
            else
              _calc.DidNotReceive().Button(Arg.Any<int>());
            if (iOperation.HasValue)
                _calc.Received(1).Operation(iOperation.Value);
            else
                _calc.DidNotReceive().Operation(Arg.Any<int>());
        }
