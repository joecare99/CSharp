...
namespace ConsoleLib
{
    ...
    {
        /// <summary>Interface structure for coordinates</summary>
        public struct COORD
        {
            public short X;
            public short Y;

            /// <summary>Initializes a new instance of the <see cref="COORD" /> struct with 2 values as coordinates.</summary>
            /// <param name="x">The x coordinate.</param>
            /// <param name="y">The y coordinate.</param>
            public COORD(short x, short y) => (X, Y) = (x, y);
            /// <summary>Gets the value as a 'Point'.</summary>
            /// <value>As point.</value>
            /// <returns>Point</returns>
            public Point AsPoint => new Point(X, Y);
        }

        /// <summary>Structure to represent a small rectangle with 'short'-values</summary>
        ...
        public struct SMALL_RECT
        {
            ...
            public short Right;
            public short Bottom;
            /// <summary>Initializes a new instance of the <see cref="SMALL_RECT" /> struct with 4 values as coordinates for the upper left and lower right corner.</summary>
        ...
        /// <summary>EventType<br />A handle to the type of (<a href="Console">Console</a>)-input event and the event record stored in the Event member.</summary>
        /// <example>
        ...
        {
            /// <summary>The 1st button from left is pressed</summary>
            FROM_LEFT_1ST_BUTTON_PRESSED = 0x0001,
            /// <summary>The 2nd button from left is pressed</summary>
            FROM_LEFT_2ND_BUTTON_PRESSED = 0x0004,
            /// <summary>The 3rd button from left is pressed</summary>
            FROM_LEFT_3RD_BUTTON_PRESSED = 0x0008,
            /// <summary>The 4th button from left is pressed</summary>
            FROM_LEFT_4TH_BUTTON_PRESSED = 0x0010,
            /// <summary>The rightmost button is pressed</summary>
            RIGHTMOST_BUTTON_PRESSED = 0x0002
        };

        /// <summary>The state of the control keys. This member can be one or more of the following values.</summary>
        [Flags]
        ...
        {
            /// <summary>  If the key is pressed, this member is <strong>TRUE</strong>. Otherwise, this member is <strong>FALSE</strong> (the key is released).</summary>
            [FieldOffset(0)]
        ...
        public enum ConsoleMode : uint
        {
            ...
            /// <summary>  Required to enable or disable extended flags. See <strong>ENABLE_INSERT_MODE</strong> and <strong>ENABLE_QUICK_EDIT_MODE</strong>.</summary>
        ...
        /// <param name="hConsoleInput">
        /// A handle to the console input buffer or a console screen buffer. The handle must have the <strong>GENERIC_READ</strong> access right. For more information, see <a href="https://docs.microsoft.com/en-us/windows/console/console-buffer-security-and-access-rights" data-linktype="relative-path"><u><font color="#0066cc">Console Buffer Security and Access Rights</font></u></a>.
        /// </param>
        /// <param name="dwMode">
        /// The input or output mode to be set. If the hConsoleHandle parameter is an input handle, the mode can be one or more of the following values. When a console is created, all input modes except ENABLE_WINDOW_INPUT are enabled by default.
        /// </param>
        /// <returns>
        ///   <para>If the function succeeds, the return value is nonzero.</para>
        ...
        /// <summary>Reads the console input.</summary>
        /// <param name="hConsoleInput">
        /// A handle to the console input buffer. The handle must have the <strong>GENERIC_READ</strong> access right. For more information, see <a href="https://docs.microsoft.com/en-us/windows/console/console-buffer-security-and-access-rights" data-linktype="relative-path"><u><font color="#0066cc">Console Buffer Security and Access Rights</font></u></a>.
        /// </param>
        /// <param name="lpBuffer">
        /// A pointer to an array of <a href="https://docs.microsoft.com/en-us/windows/console/input-record-str" data-linktype="relative-path"><strong><u><font color="#0066cc">INPUT_RECORD</font></u></strong></a> structures that receives the input buffer data.
        /// </param>
        ...
        /// <summary>Reads the console output.</summary>
        ...
        /// <returns>If the function succeeds, the return value is nonzero.<para/>If the function fails, the return value is zero. To get extended error information, call <see cref="GetLastError"/>.
        /// </returns>
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
