...
/// <summary>State exposed by the reusable calendar page.</summary>
public partial class CalendarViewModel : ObservableObject
{
    ...
    [RelayCommand]
    private void Previous() => (Year, Month) = MonthGrid.PreviousMonth(Year, Month);

    [RelayCommand]
    private void Next() => (Year, Month) = MonthGrid.NextMonth(Year, Month);
}
