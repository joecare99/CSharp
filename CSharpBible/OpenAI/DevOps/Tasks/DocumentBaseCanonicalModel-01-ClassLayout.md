# Task: Document.Base Canonical Model Class Layout Wave 01

## Parent
- Related note: `DevOps/Tasks/DocumentBaseCanonicalModel-01.md`

## Goal
Draft the first concrete class layout for `Document.Base` so the shared model can represent documents, pages, blocks, resources, and analysis metadata.
