...
{
    /// <summary>
    /// Converts supported trace source formats to flat CSV output through the shared
    ...
    public sealed class TraceCsvConversionService
    {
        ...
        /// <param name="_outputFilter">Output filter used for CSV export.</param>
        public TraceCsvConversionService(
            ...
            IOutputFilter _outputFilter)
        {
            this._inputFilterSelector = _inputFilterSelector ?? throw new ArgumentNullException(nameof(_inputFilterSelector));
            this._outputFilter = _outputFilter ?? throw new ArgumentNullException(nameof(_outputFilter));
        ...
        /// </summary>
        public IReadOnlyList<string> LoadedOutputFilterNames => [_outputFilter.GetType().Name];

        /// <summary>
        /// Converts the source file to CSV output.
        /// </summary>
        ...
        /// <summary>
        /// Converts the source stream to CSV output.
        /// </summary>
        ...
        public void Convert(Stream _inputStream, string _sourceId, Stream _outputStream)
        {
            ...
            _outputFilter.Write(dataSet, _outputStream);
        }
    }
}
