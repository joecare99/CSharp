...
- Specify executable-versus-library emit decisions
- Clarify debug-symbol expectations and defaults
...
- Supported initial emit scenarios are explicit
...
- Which initial project shapes are mandatory for the first emit milestone?
...
2. Decide the initial supported project categories
