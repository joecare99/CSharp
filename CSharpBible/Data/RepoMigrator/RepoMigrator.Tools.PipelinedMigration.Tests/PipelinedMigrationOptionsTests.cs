...
public sealed class PipelinedMigrationOptionsTests
{
    ...
    public void Parse_ThrowsForNonNumericValues(string sOptionName, string sOptionValue)
    {
        ...
        {
            StringAssert.Contains(ex.Message, "is not valid");
        }
    }
    ...
    public void Parse_ThrowsForUnexpectedArgument()
    {
        ...
        {
            StringAssert.Contains(ex.Message, "Unknown argument");
        }
    }
    ...
    [TestMethod]
    public void Validate_ThrowsForInvalidPrefetchCount()
    {
        var options = new PipelinedMigrationOptions
        {
            SourceUrl = "svn://example/source",
        ...
        {
            StringAssert.Contains(ex.Message, "prefetch count");
        }
    }

    [TestMethod]
    public void Validate_ThrowsForInvalidMaxExportWorkers()
    {
        var options = new PipelinedMigrationOptions
        {
            SourceUrl = "svn://example/source",
        ...
        {
            StringAssert.Contains(ex.Message, "worker count");
        }
    }
}
